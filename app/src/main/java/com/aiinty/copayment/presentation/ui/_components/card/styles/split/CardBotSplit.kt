package com.aiinty.copayment.presentation.ui._components.card.styles.split
...
fun CardBotSplit(
    ...
    Box(
        ...
        Image(
            painter = painterResource(id = R.drawable.card_bot_1),
...
@Preview
@Composable
private fun CardBotSplitPreview() {
    CardBotSplit(
        card = Card(
            id = "1",
